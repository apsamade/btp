        ...
        <>
            <header className="xl:pt-24 overflow-hidden bg-fond-header bg-cover pt-12 z-0 text-white relative min-h-[75vh]">
                ...
                <div className="xl:max-w-[800px] p-4 mx-auto max-w-[600px] xl:ml-32 xl:mt-24">
                    ...
                    <h1 className="xl:text-6xl xl:text-nowrap text-3xl uppercase font-semibold">Premier Titre <strong className="bg-clip-text text-transparent bg-gradient-to-r from-teal-400 to-teal-700">Principale</strong></h1>
            ...
            <section className="bg-white">
                <div className="max-w-[600px] mx-auto mt-24 pb-12">
                    ...
                    <h2 className="font-bold text-teal-950 text-center mx-auto text-3xl xl:text-5xl">Deuxieme titre du site pour les services</h2>
                </div>
                <section className="flex items-center justify-center mx-auto flex-wrap">
                    <Image
                        ...
                        width={450}
                        height={450}
                        className="xl:pb-16 px-4 xl:static relative bottom-16"
                    />
                    <div className="xl:pl-14 px-8 xl:pt-12 pb-0">
                        ...
                        <Link href='/' className="p-3 w-full text-center mt-8 block xl:w-fit py-4 text-white px-24 hover:px-32 duration-200 hover:bg-teal-500 shadow-2xl font-semibold ml-0 m-2 rounded-3xl bg-primary">
                            Contact
                        </Link>
                    </div>
                </section>
                <Image
                    ...
                    width={600}
                    height={450}
                    className="mx-auto xl:block hidden"
                />
                <section className="flex items-center xl:flex-row flex-col-reverse justify-center mx-auto flex-wrap xl:mt-0 mt-24">
                    ...
                    <Image
                        ...
                        width={500}
                        height={450}
                        className="xl:pb-16 pb-8 xl:px-0 px-4 xl:relative bottom-24"
                    />
                </section>
                <section className="max-w-[1000px] px-4 xl:px-12 p-12 mx-4 mb-24 overflow-hidden z-0 relative text-white md:mx-auto flex items-center justify-around rounded-lg bg-gradient-to-l to-teal-800 from-primary">
                    <BackgroundAnime />
                    <Image
                        alt="développemnt dans le BTP"
                        ...
                        width={300}
                        height={210}
                        className="px-12 hidden xl:block"
                    />
                    <div>
                        ...
                        <Link href='/' className="p-3 w-full text-center mt-8 block xl:w-fit py-4 text-primary px-24 hover:px-32 duration-200 hover:bg-black shadow-2xl font-semibold ml-0 m-2 rounded-3xl bg-white">
                            Contact
                        </Link>
                    </div>
                </section>
