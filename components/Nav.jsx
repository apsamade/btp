            ...
            <nav className={`lg:flex z-50 w-full hidden justify-between items-center absolute p-3`}>
                ...
                <ul className='flex justify-center items-center'>
                    <li>
                        <Link
                            href='/decouvrir'
                            className='p-4 border-b border-transparent hover:border-black duration-200'
                        >
                            Découvrir
                        </Link>
                    </li>
                ...
                <ul className='flex px-4 my-4 w-full justify-center flex-col items-start'>
                    <li>
                        <Link
                            onClick={handleNav}
                            href='/decouvrir'
                            className='p-4 py-2 my-2 block border-b border-transparent hover:border-black duration-200'
                        >
                            Découvrir
                        </Link>
                    </li>
